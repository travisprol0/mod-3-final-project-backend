...
bedroom = Room.create(name: "Bedroom", img_url: 'shorturl.at/aisuV')
office = Room.create(name: "Office", img_url: 'shorturl.at/ctIK9')
living = Room.create(name: "Living Room", img_url: 'shorturl.at/pBEY7')
