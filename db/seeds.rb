...
bedroom = Room.create(name: "Bedroom", img_url: 'https://i.imgur.com/2148t5V.jpg')
living = Room.create(name: "Living Room", img_url: 'https://i.imgur.com/sFJLjFi.jpg')
office = Room.create(name: "Office", img_url: 'https://i.imgur.com/JzS9P36.jpg')
